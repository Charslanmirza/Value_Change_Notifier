...
import 'moodVerticalBarWidget.dart';
...
class _HomeState extends State<Home> {
  ...
  void initState() {
    ...
    timerTotalEspresso =
        Timer.periodic(const Duration(seconds: 1), (timerTotalEspresso) {
    ...
    timerTotalCoffee =
        Timer.periodic(const Duration(seconds: 3), (timerTotalCoffee) {
    ...
    timerTotalLatte =
        Timer.periodic(const Duration(seconds: 2), (timerTotalLatte) {
              ...
              Row(
                ...
                children: [
                  ValueListenableBuilder(
                    valueListenable:
                        dashboardValueNotifier.value.numberOfEspresso,
                    builder: (BuildContext context, int value, Widget? child) {
                      debugPrint(
                          'numberOfEspresso: ${dashboardValueNotifier.value.numberOfEspresso.value}');
                      return MoodVerticalBarWidget(
                        icon: Icons.coffee_maker_outlined,
                        numberToPlot:
                            dashboardValueNotifier.value.numberOfEspresso.value,
                  ...
                  ValueListenableBuilder(
                    valueListenable:
                        dashboardValueNotifier.value.numberOfCoffee,
                    builder: (BuildContext context, int value, Widget? child) {
                      debugPrint(
                          'numberOfCoffee: ${dashboardValueNotifier.value.numberOfCoffee.value}');
                      return MoodVerticalBarWidget(
                          icon: Icons.coffee,
                          numberToPlot:
                              dashboardValueNotifier.value.numberOfCoffee.value,
                          numberToPlotMax: numberToPlotMax,
                          title: 'Coffee');
                    },
                  ),
                  ...
                  ValueListenableBuilder(
                    ...
                    builder: (BuildContext context, int value, Widget? child) {
                      debugPrint(
                          'numberOfLatte: ${dashboardValueNotifier.value.numberOfLatte.value}');
                      return MoodVerticalBarWidget(
                          icon: Icons.local_drink_outlined,
                          numberToPlot:
                              dashboardValueNotifier.value.numberOfLatte.value,
                          numberToPlotMax: numberToPlotMax,
                          title: 'Latte');
                    },
                  ),
